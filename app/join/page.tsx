...
export const metadata: Metadata = {
  title: "Join Us",
  description:
    "Join the CYC UT Dallas consultant cohort. Apply to work on real consulting projects, develop skills, and make an impact in the community.",
};
  ...
  return (
    <div className="mx-auto max-w-screen-xl px-4 py-20 sm:py-28 lg:px-6">
      ...
      <p className="mt-6 max-w-2xl text-lg text-muted-foreground">
        We recruit for curiosity, collaboration, and a commitment to community
        outcomes. Every member is trusted to lead and deliver meaningful impact.
